...
export default function Carousel( darkMode ) {
 ...
 <h6 className="text-xl pb-5 font-semibold text-center font-montserrat tracking-[1vw]  ">
        ...
        <Tooltip content="REACT" placement="bottom">
                        <img
                            className="w-[5vw] h-[5vh] mob:h-[7vh] mob:w-[8vw] lg:w-[3vw] lg:h-[3vw]"
                        ...
                        <img
                            className="rounded-full w-[5vw]  mob:h-[7vh] h-[5vh] lg:w-[3vw] lg:h-[3vw]"
                        ...
                        <img
                            className="rounded-full w-[5vw] h-[5vh] mob:h-[7vh] mob:w-[8vw]  lg:w-[3vw] lg:h-[3vw]"
                        ...
                        <img
                            className="rounded-full w-[5vw] h-[5vh] mob:h-[87h] mob:w-[8vw] lg:w-[3vw] lg:h-[3vw]"
