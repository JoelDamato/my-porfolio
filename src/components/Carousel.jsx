...
const Carousel = () => {
    ...
    return (
        <div className="px-4 py-5 flex-auto w-[20%] flex items-center gap-5">
            <h6 className="ml-4 text-xl font-semibold font-montserrat tracking-widest">
                TECNOLOGIAS
            </h6>

            <div className="flex mt-4 mb-4 text-gray-600 gap-8 ml-10 h-13">
               
                    
                    <Tooltip content="REACT" placement="bottom">
                        <img
                            className="w-[3vw] h-[6vh] hover:animate-bounce"
