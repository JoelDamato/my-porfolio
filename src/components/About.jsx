  ...
  return (
    ...
    <div className="w-full flex justify-evenly mob:flex-col mob:items-center">
      ...
      <div className="mob:w-[90%] w-[60%]   text-center mob:items-center">
        <div className={`h-[90%] mob:w-[100%]  flex flex-col min-w-0 ${darkMode.dark ? 'bg-gray-600/20 border-[1px] border-violet-950 text-violet-800' : 'bg-white/80'} bg-white/80  mb-8 shadow-lg rounded-lg`}>
          <div className="px-4 py-5 flex-auto">
