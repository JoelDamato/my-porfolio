...
export default function Projects(darkMode) {
 ...
 let sumar = ()=> {
  ...
  return (
    ...
    <div className={` mob:hidden shadow-lg   flex flex-col ${darkMode.dark ? 'bg-gray-700/40 border-[1px] border-violet-950 text-violet-800' : 'bg-white/80'} bg-white/80 rounded-lg w-[22%] min-h-[20%] items-center `}>
